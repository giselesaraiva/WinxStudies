...
import View.CadastroConcluidoView;
import View.CadastroIndeferidoView;
		...
		cadastroView.btnVoltaLogin.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				if (cadastrado) {
					...
					CadastroConcluidoView concluido = new CadastroConcluidoView();
					concluido.setVisible(true);
					
				}else {
					
					CadastroIndeferidoView indef = new CadastroIndeferidoView();
