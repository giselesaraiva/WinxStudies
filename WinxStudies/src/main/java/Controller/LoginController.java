...
import View.LoginConcluidoView;
import View.LoginIndeferidoView;
...
public class LoginController {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		if(loginvalido) {
			...
			LoginConcluidoView login = new LoginConcluidoView();
			login.setVisible(true);
			
		}else {
			
			LoginIndeferidoView loginIn = new LoginIndeferidoView();
