...
public class QuestoesPSView extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public QuestoesPSView() {
        initComponents();
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        QuestoesView logar=new QuestoesView();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuestoesPSView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestoesPSView().setVisible(true);
            }
        });
    }
