...
protected void paintComponent(Graphics g) {
    ...
    // Define a cor de fundo aqui
        g2d.setColor(new Color(245, 255, 253)); // Definindo a cor para F5FFFD
 // Altere para a cor desejada
    
    // Preenche o painel com a cor definida
    g2d.fillRect(0, 0, getWidth(), getHeight());
    
    // Define a transparência usando AlphaComposite
    g2d.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, alpha));
    
    // Desenha outros elementos do painel conforme necessário
