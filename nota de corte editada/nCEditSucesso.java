 ...
 */
public class nCEditSucesso extends javax.swing.JFrame {

    /**
     * Creates new form nCEditSucesso
     */
    public nCEditSucesso() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nCEditSucesso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nCEditSucesso().setVisible(true);
            }
        });
    }
