 ...
 */
public class nCAddcomSucesso extends javax.swing.JFrame {

    /**
     * Creates new form nCAddcomSucesso
     */
    public nCAddcomSucesso() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\Gisele Vieira\\Downloads\\Nota de corte adicionada com sucesso! (1).png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nCAddcomSucesso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nCAddcomSucesso().setVisible(true);
            }
        });
    }
